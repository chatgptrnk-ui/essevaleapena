...
def generate_month(year_month=None, start_date=None, days_ahead=30):
    ...
    for i, (post, day_info) in enumerate(zip(schedule, days)):
        ...
        lines.append("")
        lines.append(f"**Hashtags**: #publi #ComissõesPorCompra #anúncio #achadosamazon #{p.get('category','')} #valeapena #curadoria #amazonbrasil")
        lines.append("")
        lines.append("---")
        lines.append("")
...
def generate_reels_schedule_md(rename_reels=True):
    ...
    for i, item in enumerate(schedule, 1):
        ...
        lines.append("")
        lines.append(f"#publi #ComissõesPorCompra #anúncio #essevaleapenasim #achadosamazon #{cat} #review #curadoria #valeapena #amazonbrasil")
        lines.append("```")
        lines.append("")
